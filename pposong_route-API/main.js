...
// pposong.html에서 보낸 도보 데이터 받기
app.post("/main/PPosong/data", (req, res) => {
  const receivedData = req.body;
  console.log("Received data from client:", receivedData);

  // 여기서 receivedData.XY_TIME를 사용하여 필요한 작업을 수행

  // 클라이언트에 응답 보내기
  res.json({ response: "Data received successfully on the server!" });
});
